    ...
    <main>
        ...
        <section class="work bg-2">
            ...
            <div class="work">
                ...
                <div class="work-left">
                    <div class="work-text">
                        <p class="white font-jetbrains"><a href="projects/nihon.html" class="project-link" target="_blank">NIHON</a> <a href="https://github.com/Jackmaa/nihon-ECF-3" target="_blank">(🔗)</a><br>- An online manga library</p>
                    </div>
                    <div class="work-text">
                        <p class="white font-jetbrains"><a href="<?php echo get_permalink( get_page_by_title('DEVAURA') ); ?>" class="project-link" target="_blank">DEV'AURA</a> <a href="https://github.com/SamyMechiche/DevAura" target="_blank">(🔗)</a><br>- Developers social media</p>
                    </div>
                    <div class="work-text">
                        <p class="white font-jetbrains"><a href="projects/teamtasker.html" class="project-link" target="_blank">TEAM TASKER</a> <a href="https://github.com/SamyMechiche/ECF-2" target="_blank">(🔗)</a><br>- A shared to-do list managing tool</p>
                    </div>
                    <div class="work-text">
                        <p class="white font-jetbrains"><a href="projects/filmora.html" class="project-link" target="_blank">FILMORAMA</a> <a href="https://github.com/SamyMechiche/ECF-1" target="_blank">(🔗)</a><br>- Movies catalogue</p>
                    </div>
                    <div class="work-text">
                        <p class="white font-jetbrains"><a href="projects/visitkonoha.html" class="project-link" target="_blank">VISIT'KONOHA</a> <a href="https://github.com/SamyMechiche/landing-page" target="_blank">(🔗)</a><br>- A tour of konoha</p>
                    </div>
                    <div class="work-text">
                        <p class="white font-jetbrains"><a href="projects/guess-the-movie.html" class="project-link" target="_blank">GUESS THE MOVIE</a> <a href="https://github.com/SamyMechiche/guess-the-movie" target="_blank">(🔗)</a><br>- A Python game using TMDB API</p>
                    </div>
                </div>
                ...
                <div class="work-right">
                    <figure class="figure">
                        <video src="<?php echo get_template_directory_uri(); ?>/assets/video/nihon.mp4" controls style="border: 2px solid rgba(0, 183, 255, 0.3); border-radius: 5px;"></video>
                    </figure>
                    <figure class="figure">
                        <video src="<?php echo get_template_directory_uri(); ?>/assets/video/devaura.mp4" controls style="border: 2px solid rgba(0, 183, 255, 0.3); border-radius: 5px;"></video>
                    </figure>
                    <figure class="figure">
                        <video src="<?php echo get_template_directory_uri(); ?>/assets/video/team_tasker.mp4" controls style="border: 2px solid rgba(0, 183, 255, 0.3); border-radius: 5px;"></video>
                    </figure>
                    <figure class="figure">
                        <video src="<?php echo get_template_directory_uri(); ?>/assets/video/filmora.mp4" controls style="border: 2px solid rgba(0, 183, 255, 0.3); border-radius: 5px;"></video>
                    </figure>
                    <figure class="figure">
                        <video src="<?php echo get_template_directory_uri(); ?>/assets/video/visit_konoha.mp4" controls style="border: 2px solid rgba(0, 183, 255, 0.3); border-radius: 5px;"></video>
                    </figure>
                    <figure class="figure">
                        <video src="<?php echo get_template_directory_uri(); ?>/assets/video/pygame.mp4" controls style="border: 2px solid rgba(0, 183, 255, 0.3); border-radius: 5px;"></video>
                    </figure>
                </div>
                ...
                <div class="timeline-item">
                    <div class="timeline-content">
                        ...
                        <div class="cv-download">
                            ...
                            <a href="./assets/cv/Samy_Mechiche_CV.pdf" download class="download-btn" target="_blank">
